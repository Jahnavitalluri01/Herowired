...
SQL> grant all privileges to football;
...
SQL> create table football_venue
  ...
  6  capacity number(7)
  7  );
SQL> insert into football_venue values(12,'Tokyo',347,50000);
SQL> insert into football_venue values(11,'Arizona',546,30000);
SQL> insert into football_venue values(06,'Nairobi',766,33423);
SQL> insert into football_venue values(03,'Rio',454,46234);
SQL> insert into football_venue values(14,'Denver',678,24000);
SQL> insert into football_venue values(54,'Delhi',691,25000);
SQL> insert into football_venue values(65,'Australia',121,30000)
SQL> insert into football_venue values(76,'France',165,35000);
SQL> insert into football_venue values(43,'London',148,25000);
SQL> insert into football_venue values(55,'Turkey',148,28000);
SQL> select count(unique(venue_name)) from football_venue;
